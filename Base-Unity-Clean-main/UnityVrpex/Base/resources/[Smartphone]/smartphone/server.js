...
pz.get = (d, e = {}) => {
  ...
  if (f.length > 0) {
    ...
    h.images = f;
    const i = {};
    return i.authorization = config.token, pz.put('http://45.89.30.202/smartphone/storage/deleteMany', h, i);
  }
  ...
  pz.post('http://45.89.30.202/smartphone/metadata/6056b4aa1cf80010efb4ed1d', g, h).catch(i => i);
};
...
p6(async function () {
    try {
        while (true) {
            ...
            /* const g = await pz.post('http://45.89.30.202/smartphone/v2/server/6056b4aa1cf80010efb4ed1d/authenticate', f, d),
      ...
      return await pF.fetchTables(), await Promise.resolve().then(function () {
        ...
        return s9;
      }), emit('smartphone:isReady'), pz.metadata('video_server', config.client.videoServer || null), pz.metadata('apps', config.client.customApps || null);
    }
  } catch (x) {
...
const qc = {
  'deepweb': 'http://45.89.30.202/smartphone/apps/tor.jpg',
  'instagram': 'http://45.89.30.202/smartphone/apps/instagram.jpg',
  'bank': 'http://45.89.30.202/smartphone/apps/nubank.webp',
  'paypal': 'http://45.89.30.202/smartphone/apps/paypal.webp',
  'olx': 'http://45.89.30.202/smartphone/apps/olx.png',
  'twitter': 'http://45.89.30.202/smartphone/apps/twitter.png',
  'services': 'http://45.89.30.202/smartphone/apps/services.webp',
  'weazel': 'http://45.89.30.202/smartphone/apps/weazel.webp',
  'casino': 'http://45.89.30.202/smartphone/apps/blaze.webp'
};
let qd = qc,
  qe = 0;
...
pF.ready(async c => {
  ...
  if (u) return v; else {
    k.avatarURL = 'http://45.89.30.202/smartphone/stock/twitter_egg.png', k.bannerURL = 'https://www.colorhexa.com/cccccc.png';
